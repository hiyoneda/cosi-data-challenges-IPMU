...
void ExtractSpectrum() {
	...
	TFile * f1 = new TFile("sim_counts_spectrum.root");
	...
	myfile<<"EC[keV] EL[keV] EH[keV] BW[keV] src_ct/keV"<<endl;
	...
	for (int i = 1; i < hist1->GetNbinsX(); i++) {
		...
		//write to file:
		myfile<<hist1->GetXaxis()->GetBinCenter(i)<<"\t"<<hist1->GetXaxis()->GetBinLowEdge(i)<<"\t"<<hist1->GetXaxis()->GetBinUpEdge(i)<<"\t"<<hist1->GetXaxis()->GetBinWidth(i)<<"\t"<<hist1->GetBinContent(i)<<endl;
