...
m = 26 u as the atomic mass of 26Al nuclei, p = 0.83 is the branching ratio to emit a photon, and
...
x0 = 8.178, y0 = 0, and z0 = -0.019 are the coordinates of the Galactic centre see from Earth.
...
The two models are
Model 1:
M = 3 Msol -> L = 3.461e42 ph/s -> F = 1.063e-3 ph / cm2 / s
Re = 5.0
ze = 0.2
filenames: COSI_DC2_26Al_R5000_z0200_M30_3deg

Model2:
M = 6 Msol -> L = 6.922e42 ph/s -> F = 1.497e-3 ph / cm2 / s
Re = 5.0
ze = 1.0
