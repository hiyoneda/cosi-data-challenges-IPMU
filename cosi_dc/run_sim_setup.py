...
submit_files = os.path.join(dc_dir,"{run_script_single_thread.sh,run_sims_cosima.py,run_sims_revan.py,submit_jobs.py,run_parallel_sims.py,check_parallel_run.py}")
